...
def follow():
    ...
    if follower_distance < initial_distance0:
        ...
        k = 1.0
        if r > 0.4:
            msg0.drive.speed = 0.7 * r  #修改数值调节跟车时后车速度
        else:
    ...
    if follower_distance < initial_distance1:
        ...
        k = 1.0
        if r > 0.4:
            msg1.drive.speed = 0.7 * r  #修改数值调节跟车时后车速度
        else:
    ...
    if follower_distance < initial_distance2:
        ...
        k = 1.0
        if r > 0.4:
            msg2.drive.speed = 0.7 * r  #修改数值调节跟车时后车速度
        else:
...
if __name__ == '__main__':
    ...
    pose_flag2 = False
    pose_flag3 = False
    initial_distance0 = 0 #前后车初始距离
    initial_distance1 = 0 #前后车初始距离
    initial_distance2 = 0 #前后车初始距离
    thresh_distance = 0.2 #后车和目标点距离差
    target_point0 = Odometry() #目标点
    target_point1 = Odometry() #目标点
    target_point2 = Odometry() #目标点
